package com.multigame.games.squidgame;
...
public class SquidGameManager implements MiniGame {
    ...
    public SquidGameManager(MultiGame plugin) {
        this.plugin = plugin;
    }
    ...
    public void addPlayer(Player player) {
        ...
        player.sendMessage("§a[MultiGame] §fBienvenue dans le lobby Squid Game. En attente du lancement...");
    }
